...
firebase_admin.initialize_app(
    cred,
    {
        "databaseURL": "https://face-recognition-11fd8-default-rtdb.firebaseio.com/",
        "storageBucket": "face-recognition-11fd8.appspot.com",
    },
)
...
def generate_frame():
    ...
    imgBackground = cv2.imread("static/Files/Resources/bccackground.png")
    ...
    while True:
        ...
        if not success:
            ...
            faceCurrentFrame = face_recognition.face_locations(imgSmall, number_of_times_to_upsample=1)
